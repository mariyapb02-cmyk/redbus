...
public class SeatSelectionPage {
    ...
    By continueBtn = By.xpath("//button[contains(@aria-label,'Fill passenger details')]");
    	...
    	//WebElement bp = driver.findElement(
    	 ...
    	 //       By.xpath("//div[@class='name___d51a5f' and normalize-space()='" + name + "']/ancestor::div[@role='radio']")
    	   ...
    	   // );
    	    ...
    	    By.xpath("//div[contains(text(),'Vytilla Hub Metro Station')]/ancestor::div[@role='radio']"));
    ...
    public void chooseDroppingPoint(String name) {
    	...
    	WebElement dp = driver.findElement(
    	        ...
    	        By.xpath("//div[@role='radio' and @aria-label='05:45, 01 Feb HOSUR, Infront of Tanishq Jewellery,Staring of Flyover']")
